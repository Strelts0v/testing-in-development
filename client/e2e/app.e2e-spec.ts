...
const expectedTitle = 'HeroesTour';
const targetHero = { id: 4, name: 'Batman' };
const targetHeroDashboardIndex = 3;
const nameSuffix = 'X';
const newHeroName = targetHero.name + nameSuffix;
const heroCount = 16;
const searchTargetHero = {id: 14, name: 'Celeritas'};
...
describe('End-to-end tests for app', () => {
  ...
  describe('Heroes tests', () => {
    ...
    it('can switch to Heroes view', () => {
      ...
      expect(page.allHeroes.count()).toEqual(heroCount, 'number of heroes');
    });
    ...
    it(`deletes ${newHeroName} from Heroes list`, async () => {
      ...
      expect(page.myHeroes.isPresent()).toBeTruthy();
      expect(page.allHeroes.count()).toEqual(heroCount - 1, 'number of heroes');
...
function getPageElts() {
    ...
    return {
      ...
      topHeroes: element.all(by.css('app-root my-dashboard > div h4')),

      myHeroesHref: navElts.get(1),
      myHeroes: element(by.css('app-root my-heroes')),
      allHeroes: element.all(by.css('app-root my-heroes li')),
      selectedHero: element(by.css('app-root li.selected')),
      selectedHeroSubview: element(by.css('app-root my-heroes > div:last-child')),

      heroDetail: element(by.css('app-root hero-detail > div')),
